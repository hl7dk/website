...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-gln-identifier"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-kombit-org-identifier"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-cvr-identifier"]
      }]
    },
    {
    ...
    },
    {
      ...
      "path" : "Organization.identifier.system",
      "min" : 1,
      "fixedUri" : "urn:iso:std:iso:3166:-2"
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-producent-id"]
      }]
    },
    {
