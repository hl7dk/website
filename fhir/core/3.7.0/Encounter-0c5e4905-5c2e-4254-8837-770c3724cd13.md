# An open-ended (ongoing) inpatient encounter - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**subject**: [Schwendlund Test Mosebryggersen(official) Male, DoB: 1958-08-01 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#0108589995 (use: official, ))](Patient-283.md)
