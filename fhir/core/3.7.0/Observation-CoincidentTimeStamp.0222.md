# Coincident time stamp from Poul's home blood pressure measurement - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
Profiles: [Danish Core Observation Profile](StructureDefinition-dk-core-observation.md), [PhdCoincidentTimeStampObservation](http://hl7.org/fhir/uv/phd/STU2/StructureDefinition-PhdCoincidentTimeStampObservation.html)

**status**: Final

**code**: MDC_ATTR_TIME_ABS: Uses Absolute time clock

**subject**: [Device: identifier = Ieee 11073 System Identifier: C4-F3-12-FF-FE-53-F2-C9,Bluetooth MAC address: Bluetooth Address as a device identifier#C4-F3-12-53-F2-C9; manufacturer = A&D Medical ; serialNumber = 5181000124; modelNumber = UA-651BLE ; type = MDC_MOC_VMS_MDS_SIMP](Device-BPMonitor.C4F312FFFE53F2C9.md)
...
**device**: [Device: identifier = IEEE 11073 System Identifier: FE-ED-DA-DA-DE-AD-BE-EF; manufacturer = Trifork; modelNumber = Telma (Android); type = MDC_MOC_VMS_MDS_AHD](Device-Telma.FEEDDADADEADBEEF.md)
