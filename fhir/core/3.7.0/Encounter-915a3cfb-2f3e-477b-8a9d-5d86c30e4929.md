# A closed inpatient encounter - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**subject**: [Johnny Male, DoB: 1960-01-02 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#0201609995)](Patient-john.md)
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-encounter"]
  },
  "extension" : [{
