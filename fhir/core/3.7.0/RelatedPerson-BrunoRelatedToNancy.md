# Bruno som bror til Nancy - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**identifier**: [DK Central Person Registry (CPR)](NamingSystem-cpr.md)/2509479989

**patient**: [Nancy Ann Test Berggren (official) Female, DoB: 1948-12-25 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#2512489996)](Patient-NancyAnn.md)
