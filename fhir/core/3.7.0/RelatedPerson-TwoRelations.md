# Example of a related person with two relations - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**identifier**: [DK Central Person Registry (CPR)](NamingSystem-cpr.md)/0201919996

**patient**: [Schwendlund Test Mosebryggersen(official) Male, DoB: 1958-08-01 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#0108589995 (use: official, ))](Patient-283.md)

**relationship**: neighbor, Primær omsorgsperson
