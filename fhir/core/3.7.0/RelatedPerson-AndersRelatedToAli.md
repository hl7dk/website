# Anders som far til Ali - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**identifier**: [DK Central Person Registry (CPR)](NamingSystem-cpr.md)/3103979995

**patient**: [Ali Test Jensen (official) Male, DoB: 2022-01-31 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#3101229995)](Patient-AliJensen.md)
