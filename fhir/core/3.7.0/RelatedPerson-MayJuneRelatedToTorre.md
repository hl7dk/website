# May June som mor til Torre - HL7 FHIR Implementation Guide: DK Core v3.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **May June som mor til Torre**

## Example RelatedPerson: May June som mor til Torre
...
**patient**: [Torre Test Mosebryggersen (official) Male, DoB: 1990-04-01 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#0104909989)](Patient-Torre.md)
