# neuroradiologyUnit - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**managingOrganization**: [Organization: identifier = urn:oid:1.2.208.176.1.1#1133201000016001,http://cvr.dk#DK Central Business Register (CVR)#64942212; type = Health center](Organization-CenterForDiabetesTeamKvalitet.md)
