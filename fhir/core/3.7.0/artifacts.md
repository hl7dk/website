# Artifacts Summary - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
| [Danish Core Diagnostic Report Profile](StructureDefinition-dk-core-diagnostic-report.md) | HL7 Denmark profile for diagnostic reports. |
...
| [DK Core LOINC Diagnostic Document Types](ValueSet-dk-core-LoincDiagnosticDocumentTypes.md) | LOINC codes describing diagnostic documents that may be used for common Danish use cases. |
| [DK Core Laboratory study types](ValueSet-dk-core-LoincLabStudyTypes.md) | LOINC codes describing laboratory study types that are consistent with European use in EHDS. |
...
| [DK SOR Practice Setting Code excluding laboratory codes](ValueSet-dk-core-practice-setting-exclude-lab-code.md) | Values used for Practice Setting, as described in the SOR registry. This list excludes Laboratory Specialties . |
...
| [SNOMED CT Laboratory Specialities](ValueSet-dk-core-SCTLaboratorySpecialities.md) | SNOMED CT codes for Laboratory Specialities. Note that this is the set of accepted specialities in Europe |
...
| [Else's Laboratory report using EHDS value sets](DiagnosticReport-ElseLaboratoryReport.md) | An example of clinical chemistry report. |
...
| [Else's TOBS measurements and urin stix](DiagnosticReport-ElseHomeNursingMeasurements.md) | An example of urin stix and TOBS (Danish: Tidlig opsporing af begyndende sygdom) organized as a DiagnosticReport. |
...
| [ElseINR](Observation-ElseINR.md) |  |
| [ElseKalium](Observation-ElseKalium.md) |  |
| [ElseNatrium](Observation-ElseNatrium.md) |  |
...
| [Laboratory instance of DkCoreOrganization](Organization-KliniskBiokemiHBY.md) | Laboratory organization |
