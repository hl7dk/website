# Schwendlund som far til Odd - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**patient**: [Odd Haugen Test Mosebryggersen (official) Male, DoB: 1979-02-15 ( urn:oid:1.2.208.176.1.2#DK Central Person Registry (CPR)#1502799995)](Patient-OddHaugen.md)
