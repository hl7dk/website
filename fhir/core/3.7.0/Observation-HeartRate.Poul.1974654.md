# Poul's heart rate measurement - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
Profiles: [Danish IPA Core Observation Profile](StructureDefinition-ipa-dk-core-observation.md), [PhdNumericObservation](http://hl7.org/fhir/uv/phd/STU2/StructureDefinition-PhdNumericObservation.html), [Vital Signs Profile](http://hl7.org/fhir/R4/vitalsigns.html), [Observation Heart Rate Profile](http://hl7.org/fhir/R4/heartrate.html)
...
**Coincident Timestamp Reference**: [Observation MDC_ATTR_TIME_ABS](Observation-CoincidentTimeStamp.0222.md)
