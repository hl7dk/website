# ElsePainVRS - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
**code**: smerteintensitetsscore på verbal smerteskala
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "1144798005",
      "display" : "smerteintensitetsscore på verbal smerteskala"
    }]
  },
  "subject" : {
