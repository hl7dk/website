# Poul's remote patient monitoring app - HL7 FHIR Implementation Guide: DK Core v3.7.0
...
Profile: [PhgDevice](http://hl7.org/fhir/uv/phd/STU2/StructureDefinition-PhgDevice.html)
...
| :--- | :--- | :--- |
| - | **SystemType** | **Version** |
| * | MDC_DEV_SPEC_PROFILE_GENERIC: Device following the IEEE 11073-10206 standard but no specific specialization | 2 |
...
> **property****type**: MDC_REG_CERT_DATA_CONTINUA_CERT_DEV_LIST: Continua certified device list**valueCode**: BluetoothLE: Pulse oximeter
