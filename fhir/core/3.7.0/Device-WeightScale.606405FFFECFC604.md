# Poul's A&D weight scale - HL7 FHIR Implementation Guide: DK Core v3.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Poul's A&D weight scale**

## Example Device: Poul's A&D weight scale

Profile: [PhdDevice](http://hl7.org/fhir/uv/phd/STU2/StructureDefinition-PhdDevice.html)

**identifier**: IEEE 11073 System Identifier/60-64-05-FF-FE-CF-C6-04, Bluetooth MAC address/60-64-05-CF-C6-04
...
| :--- | :--- | :--- |
| - | **SystemType** | **Version** |
| * | MDC_DEV_SPEC_PROFILE_SCALE: Weighing scale | 1 |
...
> **version****type**: MDC_ID_PROD_SPEC_FW: Firmware version**value**: WSP002_208

> **property****type**: MDC_REG_CERT_DATA_CONTINUA_CERT_DEV_LIST: Continua certified device list**valueCode**: BluetoothLE: Weighing scale
...
{
  "resourceType" : "Device",
  "id" : "WeightScale.606405FFFECFC604",
  "meta" : {
