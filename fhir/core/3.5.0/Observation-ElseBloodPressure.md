# ElseBloodPressure - HL7 FHIR Implementation Guide: DK Core v3.5.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ElseBloodPressure**

## Example Observation: ElseBloodPressure
...
> **component****code**:Systolic blood pressure**value**: 147 mmHg(Details: UCUM codemm[Hg] = 'mm[Hg]')
