# ElseUrinStix - HL7 FHIR Implementation Guide: DK Core v3.6.0
...
**code**: U—Leukocytes; arb.c.(proc.) = ?

**subject**: [Else Test Lauridsen(official) Female, DoB: 1991-02-02 ( urn:oid:1.2.208.176.1.2#0201919990)](Patient-else.md)
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "code" : "NPU03987",
      "display" : "U—Leukocytes; arb.c.(proc.) = ?"
    },
    {
