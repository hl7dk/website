# Licensed physician in primary care - HL7 FHIR Implementation Guide: DK Core v3.6.0
...
**organization**: [Organization: identifier = urn:oid:1.2.208.176.1.1#633271000016006,http://cvr.dk#64942212; type = Health center](Organization-CenterForDiabetes.md)

**code**: Primary Care Provider

**specialty**: 408443003

> **availableTime****daysOfWeek**: Monday, Tuesday, Wednesday**availableStartTime**: 09:00:00**availableEndTime**: 15:30:00
