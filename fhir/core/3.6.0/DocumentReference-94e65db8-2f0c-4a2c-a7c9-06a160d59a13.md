# PLR-DK DocumentReference instance of DkCoreMinimalDocumentReference. - HL7 FHIR Implementation Guide: DK Core v3.6.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://hl7.dk/fhir/core/StructureDefinition/dk-core-minimaldocumentreference"]
  },
  "contained" : [{
